  ...
  return (
    <div className='pb-5 border-b border-white/20 space-y-5 group service'>
        <div className='flex justify-between items-center'>
            <span className='stroke-text font-pixel text-5xl group-hover:text-stroke-secondary'>{`${index < 10 ? "0":""}${index}`} </span>
        ...
        <p><strong className='text-white font-pixel text-4xl'>{name}</strong></p>
