...
export default function EducationTab() {
  return (
    <div>
        <motion.strong variants={fadeinVarient} initial="hidden" animate="visible" exit="hidden" className='font-pixel text-secondary text-3xl'>My Education</motion.strong>
